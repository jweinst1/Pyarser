...
setup(
  name = 'Pyrser',
  packages = ['Pyrser'], # this must be the same as the name above
  version = '0.1.0',
  description = 'A Nifty HTML Parser written in Python',
  long_description= """Pyrser is a simple, straight forward HTML parser that allows you to easily harvest text
